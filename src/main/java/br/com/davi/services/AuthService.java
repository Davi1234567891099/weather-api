...
public class AuthService {
	...
	private void createNewUser(AccountCredentialsDTO data, DelegatingPasswordEncoder passwordEncoder, String description) {
		var user = new User();
	...
	private static boolean checkIfAccountCredentialsIsNull(AccountCredentialsDTO data) {
		return isNull(data) || isNull(data.getUsername()) || isNull(data.getPassword())
				|| isBlank(data.getUsername()) || isBlank(data.getPassword());
	}
}
